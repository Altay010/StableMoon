...
contract STABLEMOON is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Stable Moon";
    string constant _symbol = "SMOON";
    uint8 constant _decimals = 8;

    uint256 _totalSupply = 1000000*(10**uint(_decimals));
    ...
    uint256 public totalFee        = marketingFee + reflectionFee + liquidityFee + buybackFee + burnFee + teamFee;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x18480A6e560c961cba3314B1e0495436dEAd7653;
        buybackFeeReceiver = 0x000000000000000000000000000000000000dEaD;
        teamFeeReceiver = 0x000000000000000000000000000000000000dEaD;
    ...
    function piruletas(bool _status) public onlyOwner {
         keloke = _status;
    }
